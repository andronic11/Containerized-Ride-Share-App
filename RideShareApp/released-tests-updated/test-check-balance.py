...
try:
	...
	r_balance = requests.get(url = URLVIEWBALANCE, headers={'Authorization': 'eyJhbGciOiAiSFMyNTYiLCAidHlwIjogIkpXVCJ9.eyJ1c2VybmFtZSI6ICJncmlmZmluIn0=.803e985bbf6d4da2b9f42d0de4f33539396ecf4d82b2bffde2d29adf7d36aedb'})
	balance_data = r_balance.json()
	print('Balance Data:', balance_data)

	if balance_data['balance'] != '6.00':
		quit()
