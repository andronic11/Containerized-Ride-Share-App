...
try:
	...
	URLGETUSER = "http://127.0.0.1:9000/get_user"
	...
	r_create_availability = requests.post(url = URLAVAILABILITY, data = ADDAVAILABILITYPARAMS, headers={'Authorization': 'eyJhbGciOiAiSFMyNTYiLCAidHlwIjogIkpXVCJ9.eyJ1c2VybmFtZSI6ICJncmlmZmluIn0=.803e985bbf6d4da2b9f42d0de4f33539396ecf4d82b2bffde2d29adf7d36aedb'})
	create_availability_data = r_create_availability.json()

	if create_availability_data['status'] != 2:
		print(4)
		print(create_availability_data['status'])
		quit()
	...
	r_user = requests.get(url = URLGETUSER, params = {'username':'jmm'})
	user_data = r_user.json()
	
	if create_availability_data['status'] != 1:
		print(5)
		quit()
